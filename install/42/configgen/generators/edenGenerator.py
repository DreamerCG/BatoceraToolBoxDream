...
class EdenGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        yuzuConfig = batoceraFiles.CONF + '/eden/qt-config.ini'
    ...
    # UI section
        ...
        if system.isOptSet('eden_enable_discord_presence'):
            yuzuConfig.set("UI", "enable_discord_presence", system.config["eden_enable_discord_presence"])
        else:
    ...
    # Data Storage section
        ...
        yuzuConfig.set("Data%20Storage", "dump_directory", "/userdata/system/configs/eden/dump")
        yuzuConfig.set("Data%20Storage", "dump_directory\\default", "true")

        yuzuConfig.set("Data%20Storage", "load_directory", "/userdata/system/configs/eden/load")
        yuzuConfig.set("Data%20Storage", "load_directory\\default", "true")

        yuzuConfig.set("Data%20Storage", "nand_directory", "/userdata/system/configs/eden/nand")
        yuzuConfig.set("Data%20Storage", "nand_directory\\default", "true")

        yuzuConfig.set("Data%20Storage", "sdmc_directory", "/userdata/system/configs/eden/sdmc")
        yuzuConfig.set("Data%20Storage", "sdmc_directory\\default", "true")

        yuzuConfig.set("Data%20Storage", "tas_directory", "/userdata/system/configs/eden/tas")
    ...
    # Renderer section
        ...
        if system.isOptSet('eden_ratio'):
            yuzuConfig.set("Renderer", "aspect_ratio", system.config["eden_ratio"])
        ...
        if system.isOptSet('eden_backend'):
            yuzuConfig.set("Renderer", "backend", system.config["eden_backend"])
        else:
    ...
    # controls section
        ...
        if ((system.isOptSet('eden_auto_controller_config') and not (system.config["eden_auto_controller_config"] == "0")) or not system.isOptSet('eden_auto_controller_config')):
            ...
            print("[INPUT] Using GUIDs in EdenGenerator: ", use_batocera_guids, file=sys.stderr)
            filename = "/userdata/system/configs/eden/debug_controllers.txt"
            ...
            if system.isOptSet("eden_enable_rumble"):
                yuzuConfig.set("Controls", "vibration_enabled", system.config["eden_enable_rumble"])
                yuzuConfig.set("Controls", "vibration_enabled\\default", system.config["eden_enable_rumble"])
            else:
                    ...
                    if(sdl_mapping == None):
                        ...
                        if (system.isOptSet(which_pad) and (system.config[which_pad] == "2")):
                            ...
                            for x in yuzuButtons:
                                yuzuConfig.set("Controls", "player_" + controllernumber + "_" + x, '"{}"'.format(EdenGenerator.setButton(yuzuButtons[x], inputguid, controller.inputs,portnumber)))
                                yuzuConfig.set("Controls", "player_" + controllernumber + "_" + x + "\\default", "false")

                            for x in yuzuAxis:
                                yuzuConfig.set("Controls", "player_" + controllernumber + "_" + x, '"{}"'.format(EdenGenerator.setAxis(yuzuAxis[x], inputguid, controller.inputs, portnumber, 1)))
                                yuzuConfig.set("Controls", "player_" + controllernumber + "_" + x + "\\default", "false")
                            ...
                            for x in yuzuAxis:
                                yuzuConfig.set("Controls", "player_" + controllernumber + "_" + x, '"{}"'.format(EdenGenerator.setAxis(yuzuAxis[x], inputguid, controller.inputs, portnumber,2)))
                                yuzuConfig.set("Controls", "player_" + controllernumber + "_" + x + "\\default", "false")
                            ...
                            for x in yuzuAxis:
                                yuzuConfig.set("Controls", "player_" + controllernumber + "_" + x, '"{}"'.format(EdenGenerator.setAxis(yuzuAxis[x], inputguid, controller.inputs, portnumber,0)))     
                                yuzuConfig.set("Controls", "player_" + controllernumber + "_" + x + "\\default", "false")
                        ...
                        if system.isOptSet("eden_enable_rumble"):
                            yuzuConfig.set("Controls", "player_" + controllernumber + "_vibration_enabled", system.config["eden_enable_rumble"])
                            yuzuConfig.set("Controls", "player_" + controllernumber + "_vibration_enabled\\default", system.config["eden_enable_rumble"])
                        else:
    ...
    def setButton(key, padGuid, padInputs,controllernumber):
        ...
        if key in padInputs:
            ...
            if input.type == "button":
                ...
                return ("hat:{},direction:{},guid:{},port:{},engine:sdl").format(input.id, EdenGenerator.hatdirectionvalue(input.value), padGuid, controllernumber)
