                ...
                if(controller.guid != "050000007e0500000620000001800000" and controller.guid != "050000007e0500000720000001800000"):
                    ...
                    if(sdl_mapping == None):
                        ...
                        if (system.isOptSet(which_pad) and (system.config[which_pad] == "2")):
                            ...
                            for x in yuzuAxis:
                                yuzuConfig.set("Controls", "player_" + controllernumber + "_" + x, '"{}"'.format(YuzuGenerator.setAxis(yuzuAxis[x], inputguid, controller.inputs, portnumber, 1)))
                                yuzuConfig.set("Controls", "player_" + controllernumber + "_" + x + "\\default", "false")
                            ...
                            for x in yuzuAxis:
                                yuzuConfig.set("Controls", "player_" + controllernumber + "_" + x, '"{}"'.format(YuzuGenerator.setAxis(yuzuAxis[x], inputguid, controller.inputs, portnumber,2)))
                                yuzuConfig.set("Controls", "player_" + controllernumber + "_" + x + "\\default", "false")
                            ...
                            for x in yuzuAxis:
                                yuzuConfig.set("Controls", "player_" + controllernumber + "_" + x, '"{}"'.format(YuzuGenerator.setAxis(yuzuAxis[x], inputguid, controller.inputs, portnumber,0)))     
                                yuzuConfig.set("Controls", "player_" + controllernumber + "_" + x + "\\default", "false")
