...
class EdenGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        ...
        self.force_symlink("/userdata/bios/switch/keys_yuzu","/userdata/system/configs/yuzu/keys")
        self.force_symlink("/userdata/bios/switch/firmware_yuzu","/userdata/system/configs/yuzu/nand/system/Contents/registered")
