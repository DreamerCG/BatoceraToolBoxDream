...
initialize_common() {
	...
	# COPIE ALL IMAGE FOR SWITCH ROMS
	message "log" "$addon_log" "Copying All Images for Switch Roms. => /userdata/roms/switch/images/"
	cp -rfT "$switch_install_roms_switch_images_dir" "$switch_switch_images_dir" 2>>"$stderr_log"
