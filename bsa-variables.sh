...
yuzu_system_saves_dir="$switch_saves_dir/eden_citron/save/save_system" # NAND SYSTEM SAVES (NEW)
yuzu_user_saves_dir="$switch_saves_dir/eden_citron/save/save_user" # NAND USER SAVES (NEW)
