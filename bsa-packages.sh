...
unpack_packages_common() {
	...
	bin_folder_open = xdg-open
	mkdir -p "$switch_bin_dir/xdgfix" 2>>"$stderr_log"
	copy_make_executable "$bin_folder_open" "$switch_install_script_dir" "$switch_bin_dir/xdgfix"
